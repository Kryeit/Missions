package com.kryeit.forge.datagen.custom;
...
public class ExchangeATMRecipeBuilder implements RecipeBuilder {
    private final Item result;
    private final Ingredient ingredient;
    private final int count;
    private final Advancement.Builder advancement = Advancement.Builder.advancement();

    public ExchangeATMRecipeBuilder(ItemLike ingredient, ItemLike result, int count) {
    ...
    public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        pFinishedRecipeConsumer.accept(new ExchangeATMRecipeBuilder.Result(pRecipeId, this.result, this.count, this.ingredient,
    ...
    public static class Result implements FinishedRecipe {
        ...
        public RecipeSerializer<?> getType() {
            return ExchangeATMRecipe.Serializer.INSTANCE;
        }
