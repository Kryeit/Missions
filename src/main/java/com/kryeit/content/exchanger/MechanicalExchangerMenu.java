...
public class MechanicalExchangerMenu extends AbstractContainerMenu {
    ...
    public MechanicalExchangerMenu(MenuType<?> type, int pContainerId, Inventory inv, RegistryFriendlyByteBuf extraData) {
    ...
    public MechanicalExchangerMenu(MenuType<?> type, int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.addSlot(new Slot(blockEntity, 0, 45, 35));
        this.addSlot(new ModResultSlot(blockEntity, 1, 116, 35));
